Этот урок сделан по мотивам урока Состояние из курса по реакту. Здесь вам нужно реализовать тот же компонент, но используя функциональные компоненты и хуки.
